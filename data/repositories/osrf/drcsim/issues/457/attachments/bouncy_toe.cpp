...
int main(int argc, char** argv)
{
    ...
    asic.step_params.desired_step.pose.position.x =  0.35;
    ...
    asic.step_params.desired_step.pose.position.x =  0.50;
    ...
    // Wait for transition
    while (G_atlassiminterface_msg.step_feedback.next_step_index_needed != 3) {
        ros::spinOnce();
	usleep(10000);
    }
    ...
    // send next step
    asic.step_params.desired_step.foot_index = 0;
    asic.step_params.desired_step.step_index = 3;
    asic.step_params.desired_step.pose.position.x =  0.85;
    asic.step_params.desired_step.pose.position.y =  0.16;
