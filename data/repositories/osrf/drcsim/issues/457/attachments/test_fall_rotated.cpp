...
int main(int argc, char** argv)
{
    ...
    asic.step_params.desired_step.pose.position.x =  0.129;
    asic.step_params.desired_step.pose.position.y =  0.018;
    asic.step_params.desired_step.pose.position.z = 0.0;
    asic.step_params.desired_step.pose.orientation.x = 0.0;
    asic.step_params.desired_step.pose.orientation.y = 0.0;
    asic.step_params.desired_step.pose.orientation.z = 0.671;
    asic.step_params.desired_step.pose.orientation.w = 0.742;
    ...
    asic.step_params.desired_step.pose.position.x = -0.134;
    asic.step_params.desired_step.pose.position.y =  0.090;
    pub_bdi1.publish(asic);
    usleep(100000);
