...
int main(int argc, char** argv)
{
    ...
    asic.step_params.desired_step.pose.position.x =  0.018;
    asic.step_params.desired_step.pose.position.y = -0.129;
    ...
    asic.step_params.desired_step.pose.position.x = 0.090;
    asic.step_params.desired_step.pose.position.y = 0.134;
    pub_bdi1.publish(asic);
    usleep(100000);
